...
{
	[CompilerGenerated]
	private sealed class _003CtakeScreenShot_003Ec__Iterator0 : IEnumerator, IEnumerator<object>, IDisposable
	{
		...
		internal string _003C_0024_003Efilename;

		internal Action<string> _003C_0024_003EcompletionHandler;
		...
		public bool MoveNext()
		{
			...
			{
			case 0u:
				_0024current = AbstractManager.coroutineSurrogate.StartCoroutine(getScreenShotTexture(_003C_003Em__0));
				_0024PC = 1;
				return true;
			case 1u:
				_0024PC = -1;
		...
		internal void _003C_003Em__0(Texture2D tex)
		{
	...
	[CompilerGenerated]
	private sealed class _003CshowMailComposerWithScreenshot_003Ec__Iterator2 : IEnumerator, IEnumerator<object>, IDisposable
	{
		...
		internal string _003C_0024_003EtoAddress;

		internal string _003C_0024_003Esubject;

		internal string _003C_0024_003Ebody;

		internal bool _003C_0024_003EisHTML;
		...
		public bool MoveNext()
		{
			...
			case 0u:
				...
				{
					_0024current = AbstractManager.coroutineSurrogate.StartCoroutine(getScreenShotTexture(_003C_003Em__1));
					_0024PC = 1;
					return true;
				}
				goto case 1u;
		...
		internal void _003C_003Em__1(Texture2D tex)
		{
			byte[] attachmentData = tex.EncodeToPNG();
			showMailComposerWithAttachment(attachmentData, "image/png", "screenshot.png", toAddress, subject, body, isHTML);
		}
	}
	...
	{
		yield break;
		//yield return AbstractManager.coroutineSurrogate.StartCoroutine(getScreenShotTexture(((_003CtakeScreenShot_003Ec__Iterator0)this)._003C_003Em__0));
	}
	...
	public static IEnumerator showMailComposerWithScreenshot(string toAddress, string subject, string body, bool isHTML)
	{
		//if (Application.platform == RuntimePlatform.IPhonePlayer)
		//{
		//	yield return AbstractManager.coroutineSurrogate.StartCoroutine(getScreenShotTexture(((_003CshowMailComposerWithScreenshot_003Ec__Iterator2)this)._003C_003Em__1));
		//}
		yield break;
	}
	...
	public static void showMailComposerWithAttachment(string filePathToAttachment, string attachmentMimeType, string attachmentFilename, string toAddress, string subject, string body, bool isHTML)
	{
		if (Application.platform == RuntimePlatform.IPhonePlayer)
		{
			...
			{
				UnityEngine.Debug.Log("file path passed to showMailComposerWithAttachment is not a legit path: " + filePathToAttachment + ". Be sure to test your paths with File.Exists before using them!");
				return;
			}
			if (!File.Exists(filePathToAttachment))
			{
				UnityEngine.Debug.Log("file path passed to showMailComposerWithAttachment does not exist: " + filePathToAttachment + ". Be sure to test your paths with File.Exists before using them!");
				return;
			}
