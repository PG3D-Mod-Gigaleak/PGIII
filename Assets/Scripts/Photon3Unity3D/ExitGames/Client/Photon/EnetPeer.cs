...
namespace ExitGames.Client.Photon
{
	internal class EnetPeer : PeerBase
	{
		...
		private sealed class _003C_003Ec__DisplayClassd
		{
			...
			{
				CS_0024_003C_003E8__localsc._003C_003E4__this.rt.SendUdpPackage(dataCopy, CS_0024_003C_003E8__localsc.length);
			}
		}
		...
		internal void SendData(byte[] data, int length)
		{
			...
			try
			{
				...
				{
					rt.SendUdpPackage(data, _003C_003Ec__DisplayClassb.length);
				}
			}
			catch (Exception ex)
			{
